...
namespace EstateIQ.Migrations
{
    ...
    [Migration("20260526114542_AddPropertyMlDetailFields")]
    partial class AddPropertyMlDetailFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EstateIQ.Models.Property", b =>
                {
                    ...
                    b.Property<string>("BasementAreaUnit")
                        .HasMaxLength(10)
                    ...
                    b.Property<decimal?>("NearbyLivingArea")
                        .HasColumnType("decimal(10,2)");

                    b.Property<string>("NearbyLivingAreaUnit")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");

                    b.Property<decimal?>("NearbyLotArea")
                        .HasColumnType("decimal(10,2)");

                    b.Property<string>("NearbyLotAreaUnit")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
                    ...
                    b.ToTable("Properties", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Properties_BasementArea", "[BasementArea] IS NULL OR [BasementArea] > 0");

                            t.HasCheckConstraint("CK_Properties_Condition", "[Condition] IS NULL OR ([Condition] >= 1 AND [Condition] <= 5)");

                            t.HasCheckConstraint("CK_Properties_Grade", "[Grade] IS NULL OR ([Grade] >= 1 AND [Grade] <= 13)");
                            ...
                            t.HasCheckConstraint("CK_Properties_LotArea", "[LotArea] IS NULL OR [LotArea] > 0");

                            t.HasCheckConstraint("CK_Properties_NearbyLivingArea", "[NearbyLivingArea] IS NULL OR [NearbyLivingArea] > 0");

                            t.HasCheckConstraint("CK_Properties_NearbyLotArea", "[NearbyLotArea] IS NULL OR [NearbyLotArea] > 0");

                            t.HasCheckConstraint("CK_Properties_Price", "[Price] > 0");

                            t.HasCheckConstraint("CK_Properties_ViewQuality", "[ViewQuality] IS NULL OR ([ViewQuality] >= 0 AND [ViewQuality] <= 4)");

                            t.HasCheckConstraint("CK_Properties_YearBuilt", "[YearBuilt] IS NULL OR ([YearBuilt] >= 1800 AND [YearBuilt] <= YEAR(GETDATE()))");

                            t.HasCheckConstraint("CK_Properties_YearRenovated", "[YearRenovated] IS NULL OR ([YearRenovated] >= 1800 AND [YearRenovated] <= YEAR(GETDATE()))");

                            t.HasCheckConstraint("CK_Properties_Zipcode", "[Zipcode] IS NULL OR ([Zipcode] >= 1 AND [Zipcode] <= 99999)");
                        });
                });
